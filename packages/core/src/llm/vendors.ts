...
export const VENDORS: Record<string, VendorDef> = {
  openai: { id: "openai", name: "OpenAI", flavor: "openai", baseURL: "https://api.openai.com/v1", allowPrefixes: [], denyPrefixes: ["whisper-", "tts-", "dall-e-", "text-embedding-", "gpt-4o-audio-", "omni-moderation"], defaultModel: "gpt-4o-mini", effort: { ...OE, modelAllowlist: ["o1-", "o3-", "o4-", "gpt-5"] } },
